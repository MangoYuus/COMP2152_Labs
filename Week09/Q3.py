...
class TestValidIP(unittest.TestCase):
    def test_valid(self):
        self.assertTrue(is_valid_ip("192.168.1.1"), True)

    def test_invalid_octet(self):
        self.assertTrue(is_valid_ip("256.1.1.1"), False)

    def test_too_few_parts(self):
        self.assertTrue(is_valid_ip("1.2.3"), False)

    def test_empty(self):
        self.assertTrue(is_valid_ip(""), False)
